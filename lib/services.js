...
export const adminDashboardService = {
  ...
  getActivities: () => api.get("/api/v1/admin/activities/"),

  getAlerts: () => api.get("/api/v1/admin/alerts/"),

  createAlert: (data) => api.post("/api/v1/admin/alerts/", data),

  updateAlert: (id, data) => api.put(`/api/v1/admin/alerts/${id}/`, data),

  deleteAlert: (id) => api.delete(`/api/v1/admin/alerts/${id}/`),
