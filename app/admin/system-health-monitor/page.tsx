  ...
  return (
    <main className="min-h-screen bg-[#EAEAEA] p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-xl font-bold text-[#0A1B2E]">
      ...
      <div>
        <h2 className="text-sm font-bold text-[#0A1B2E] uppercase tracking-wide mb-6">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-200">
          ...
          <div className="mb-10">
            <h3 className="text-xs font-bold text-[#0A1B2E] uppercase tracking-wide mb-6 pb-4 border-b border-gray-200">
              SYSTEM COMPONENT HEALTH
            </h3>
          ...
          <div className="pt-8 border-t border-gray-200">
            <h3 className="text-xs font-bold text-[#0A1B2E] uppercase tracking-wide mb-6">
              PERFORMANCE METRICS
            </h3>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="flex items-center justify-center col-span-1">
              ...
              >
                ...
                <circle cx={140} cy={140} r={45} fill="#eab308" opacity="0.9" />
                {/* Light pink overlay on green */}
                <circle cx={140} cy={140} r={80} fill="#fce7f3" opacity="0.3" />
              </svg>
            </div>
            ...
            <div className="col-span-2 flex flex-col justify-between">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button className="px-6 py-2 bg-slate-900 text-white text-sm rounded-full font-medium hover:bg-slate-800">
                    Show All
                  </button>
                  <button className="px-6 py-2 bg-blue-600 text-white text-sm rounded-full font-medium hover:bg-blue-700">
                    Only Critical
                  </button>
                  <button className="px-6 py-2 bg-slate-900 text-white text-sm rounded-full font-medium hover:bg-slate-800">
                    By Region
